...
namespace VigenereDecoderMVVM
{
    ...
    /// </summary>
    public class FrequencyDecipherItemViewModel : BaseViewModel
    {
        /// <summary>
        ...
        /// Default constructor
        /// </summary>
        public FrequencyDecipherItemViewModel(string cipheredText, string fileName)
        {
            CipheredText = cipheredText;
            SanitisedCipheredString = DecipherHelper.SanitiseString(cipheredText);
            FileName = fileName;
